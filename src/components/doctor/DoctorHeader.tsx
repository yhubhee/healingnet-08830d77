        ...
        <div className="flex items-center gap-3">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                ...
                className="relative w-10 h-10 rounded-lg hover:bg-card transition-colors flex items-center justify-center"
              >
              ...
              {recent.length === 0 ? (
                ...
                recent.map((n) => (
                  <DropdownMenuItem
                    key={n.id}
                    className={cn(
                      "notification-item flex flex-col items-start gap-1 py-3 cursor-pointer",
          ...
          <div className="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold overflow-hidden">
            {doctor?.profile_image_url ? (
              <img src={doctor.profile_image_url} alt="" className="w-full h-full object-cover" />
            ) : (
