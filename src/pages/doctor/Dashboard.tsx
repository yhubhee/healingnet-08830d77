...
import { Calendar, Users, MessageSquare, TrendingUp, Loader2, Pill, FlaskConical, Mail } from "lucide-react";
...
export default function DoctorDashboard() {
  ...
  const cards = [
    ...
    { label: "Active Patients", value: dash?.patientCount || 0, icon: Users, color: "bg-success/10 text-success" },
